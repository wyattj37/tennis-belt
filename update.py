...
atp_new_matches = [
    ...
    'round': 'R32',
    'surface': 'Hard',
    'tourney_date': '2026-02-17',
    'winner_name': 'Carlos Alcaraz',
    'winner_ioc': 'ESP',
    'loser_name': 'Arthur Rinderknech',
    'loser_ioc': 'FRA',
    'score': '6-4 7-6(5)',
    'defenses': 1,
    'change': 'No'},
    ...
    'round': 'R16',
    'surface': 'Hard',
    'tourney_date': '2026-02-18',
    'winner_name': 'Carlos Alcaraz',
    'winner_ioc': 'ESP',
    'loser_name': 'Valentin Royer',
    'loser_ioc': 'FRA',
    'score': '6-2 7-5',
    'defenses': 2,
    'change': 'No'},
...
wta_new_matches = [
    ...
    # 'round': 'SF',
    # 'surface': 'Hard',
    # 'tourney_date': '2026-02-13',
    # 'winner_name': 'Victoria Mboko',
    # 'winner_ioc': 'CAN',
    # 'loser_name': 'Jelena Ostapenko',
    # 'loser_ioc': 'LAT',
    # 'score': '6-3 6-2',
    # 'defenses' : 1,
    # 'change': 'No'},
